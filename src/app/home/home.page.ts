...
import { logOut, heart, fitness, walk, medical, pulse, musicalNotes, personAdd, alertCircle, water, cloud, sunny, rainy, partlySunny, personCircle, speedometer, grid, list, chevronForward, logoGoogle, mail, share, home, people, cart, settings, calendar, ellipsisVertical, moon } from 'ionicons/icons';
...
export class HomePage implements OnInit {
  ...
  constructor(
    ...
    addIcons({personCircle,logOut,heart,moon,fitness,calendar,medical,musicalNotes,personAdd,alertCircle,ellipsisVertical,chevronForward,walk,pulse,share,water,speedometer,logoGoogle,grid,list,cloud,sunny,rainy,partlySunny,mail,home,people,cart,settings});
  }
  ...
  getPhotoURL(user: User | null): string | null {
    ...
    // Primeiro, verificar se existe uma foto salva localmente para este email (fallback)
    try {
